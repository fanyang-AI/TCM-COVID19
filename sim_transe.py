...
entity2id = {}
id2entity = {}
with open(r"C:\Users\Desktop\dckg\entity2id.txt", newline='', encoding='gbk') as csvfile:
...
# 提取嵌入后的向量
entity_emb = []
with open(r"C:\Users\Desktop\dckg\entityVector.txt", newline='', encoding='UTF-8') as csvfile:
